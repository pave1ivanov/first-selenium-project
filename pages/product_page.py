...
class ProductPage(BasePage):
    ...
    def should_be_correct_product_in_success_message(self):
        ...
        assert product_name in success_message_product_name, f"Product name '{product_name}'in success message is not correct - '{success_message_product_name}'"
    ...
    def should_be_correct_price_in_info_message(self):
        ...
        assert product_price in info_message_product_price, f"Product price '{product_price}'in info message is not correct - '{info_message_product_price}'"